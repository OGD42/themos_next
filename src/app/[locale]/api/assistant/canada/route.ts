import { TRANSLATION_MESSAGE } from "@/constants/translation";
...
export async function POST(req: Request) {
  ...
  const ASSISTANT = process.env.CANADA_ASSISTANT_ID as string;
  ...
  if (locale === "en") {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: TRANSLATION_MESSAGE.english,
        },
        {
          role: "user",
          content: message,
    ...
    const grammarCheck = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: TRANSLATION_MESSAGE.spanish,
        },
        {
          role: "user",
          content: message,
